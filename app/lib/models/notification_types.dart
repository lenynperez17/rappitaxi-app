...
/// Tipos de notificaciones del sistema RapiTeam
...
enum NotificationChannel {
  general('rapiteam_general', 'General', 'Notificaciones generales'),
  rides('rapiteam_rides', 'Viajes', 'Notificaciones de viajes'),
  payments('rapiteam_payments', 'Pagos', 'Notificaciones de pago'),
  emergency('rapiteam_emergency', 'Emergencias', 'Alertas de seguridad'),
  chat('rapiteam_chat', 'Chat', 'Mensajes de chat'),
  promotions('rapiteam_promotions', 'Promociones', 'Ofertas y descuentos');
