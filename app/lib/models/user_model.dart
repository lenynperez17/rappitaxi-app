...
class UserModel {
  ...
  /// Verificar si es admin (only the designated admin email is allowed)
  static const String adminEmail = 'facturacion.rapiteam@gmail.com';
  bool get isAdmin => userType == 'admin' && email.toLowerCase() == adminEmail;
