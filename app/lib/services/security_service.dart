...
class SecurityService {
  ...
  int getPasswordStrengthScore(String password) {
    ...
    // Palabras comunes
    final commonPasswords = ['password', 'admin', 'rappi', 'taxi', '12345', 'qwerty'];
  ...
  /// Generar token seguro usando Random.secure() criptografico
  String generateSecureToken([int length = 32]) {
    final secureRandom = Random.secure();
    final randomBytes = List<int>.generate(length, (_) => secureRandom.nextInt(256));
