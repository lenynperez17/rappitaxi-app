...
class _AnalyticsScreenState extends State<AnalyticsScreen>
  ...
  Widget _buildSectionHeader({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: RtColors.brand.withValues(alpha: 0.05),
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        _buildKPICard(
          ...
          RtColors.success,
          '${(_analyticsData['revenueChange'] as double).toStringAsFixed(1)}%', // ✅ Calculado desde Firebase
        ...
        _buildKPICard(
          ...
          Colors.orange,
          '${(_analyticsData['activeDriversPercentage'] as double).toStringAsFixed(1)}% activos', // ✅ Calculado desde Firebase
        ...
        _buildKPICard(
          ...
          Icons.straighten,
          Colors.cyan,
          '${(_analyticsData['distanceChange'] as double).toStringAsFixed(1)}%', // ✅ Calculado desde Firebase
        ...
        _buildKPICard(
          ...
          Icons.timer,
          Colors.teal,
          '${(_analyticsData['durationChange'] as double).toStringAsFixed(0)} min', // ✅ Calculado desde Firebase
        ...
        _buildKPICard(
          ...
          Icons.payments,
          Colors.indigo,
          (_analyticsData['priceChange'] as double).toCurrencyWithSign(), // ✅ Calculado desde Firebase
        ...
        _buildKPICard(
          ...
          '${(_analyticsData['ratingChange'] as double) >= 0 ? '+' : ''}${(_analyticsData['ratingChange'] as double).toStringAsFixed(2)}', // ✅ Calculado desde Firebase
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: (isPositive ? RtColors.success : RtColors.error).withValues(alpha: 0.2),
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      ...
                      size: 10,
                      color: isPositive ? RtColors.success : RtColors.error,
                    ),
                    SizedBox(width: 2),
                    Text(
                      change,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('00:00', style: TextStyle(color: RtColors.neutral500, fontSize: 10)),
              Text('06:00', style: TextStyle(color: RtColors.neutral500, fontSize: 10)),
              Text('12:00', style: TextStyle(color: RtColors.neutral500, fontSize: 10)),
              Text('18:00', style: TextStyle(color: RtColors.neutral500, fontSize: 10)),
              Text('23:00', style: TextStyle(color: RtColors.neutral500, fontSize: 10)),
            ],
          ),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              color: RtColors.neutral900, // ✅ CORREGIDO: usar color del tema
              fontSize: 16,
              fontWeight: FontWeight.bold,
            ),
          ),
              ...
              return Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: RtColors.neutral500, fontSize: 11), // ✅ CORREGIDO: usar color del tema
                  ),
                ],
              );
            }),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: RtColors.success.withValues(alpha: 0.2),
              borderRadius: BorderRadius.circular(12),
            ),
            child: Text(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        SizedBox(width: 120, child: Text('Zona', style: TextStyle(color: RtColors.neutral500, fontSize: 12, fontWeight: FontWeight.bold))),
                        SizedBox(width: 60, child: Text('Viajes', style: TextStyle(color: RtColors.neutral500, fontSize: 12, fontWeight: FontWeight.bold))),
                        SizedBox(width: 80, child: Text('Ingresos', style: TextStyle(color: RtColors.neutral500, fontSize: 12, fontWeight: FontWeight.bold))),
                        SizedBox(width: 80, child: Text('Prom.', style: TextStyle(color: RtColors.neutral500, fontSize: 12, fontWeight: FontWeight.bold))),
                      ],
                    ),
                  ),
                        ...
                        children: [
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    zone['zone'],
                                    style: TextStyle(color: RtColors.neutral900, fontSize: 12),
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 1,
                                  ),
                                ),
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(color: RtColors.success, fontSize: 13),
                            ),
                          ),
                        ],
                      ),
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                ...
                child: Text(
                  'Ver todos',
                  style: TextStyle(color: RtColors.brand),
                ),
              ),
            ],
          ),
          ...
          ..._driverPerformance.asMap().entries.map((entry) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: index == 0
                    ? RtColors.accentAmber.withValues(alpha: 0.3)
                    : Colors.transparent,
                ),
              ),
              child: Row(
                    ...
                    child: Text(
                      ...
                      driver['name'].toString().trim().isNotEmpty
                        ? driver['name'].toString().trim().split(' ')
                            ...
                            .join()
                        : '?',
                      style: TextStyle(color: RtColors.brand, fontSize: 12),
                    ),
                  ),
                  SizedBox(width: 8), // ✅ Reducido de 12 a 8
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${driver['trips']} viajes • ${(driver['hours'] as double).toStringAsFixed(1)}h', // ✅ Acortado
                          style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Icon(Icons.star, size: 12, color: RtColors.accentAmber), // ✅ Reducido de 14 a 12
                            Text(
                              ' ${(driver['rating'] as double).toStringAsFixed(1)}', // ✅ Formato decimal corto
                              style: TextStyle(
                                color: RtColors.neutral500,
                                fontSize: 11, // ✅ Reducido de 12 a 11
                              ),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              color: RtColors.neutral900, // ✅ CORREGIDO
              fontSize: 16,
              fontWeight: FontWeight.bold,
            ),
          ),
          ...
          Text(
            'Distribución de Calificaciones',
            style: TextStyle(
              color: RtColors.neutral500, // ✅ CORREGIDO
              fontSize: 14,
              fontWeight: FontWeight.bold,
            ),
          ),
                ...
                children: [
                  Row(
                    children: List.generate(5, (index) => Icon(
                      Icons.star,
                      size: 12,
                      color: index < stars ? RtColors.accentAmber : Theme.of(context).colorScheme.surfaceContainerHighest,
                    )),
                  ),
                  SizedBox(width: 12),
                  Expanded(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            subtitle,
            style: TextStyle(
              color: RtColors.neutral500.withValues(alpha: 0.7), // ✅ CORREGIDO
              fontSize: 10,
            ),
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  label,
                  style: TextStyle(color: RtColors.neutral900, fontSize: 14), // ✅ CORREGIDO
                ),
                Text(
                  '${percentage.toStringAsFixed(1)}% del total',
                  style: TextStyle(color: RtColors.neutral500, fontSize: 11), // ✅ CORREGIDO
                ),
              ],
            ),
          ),
  ...
  void _refreshData() async {
    ...
    RtSnackbar.show(context, message: 'Datos actualizados', type: RtSnackbarType.success);
  }
  
  Future<void> _exportReport() async {
    try {
      // Mostrar indicador de carga
      RtSnackbar.show(context, message: 'Generando reporte...', type: RtSnackbarType.info);

      // Generar contenido CSV
      final csvData = [
        ['Reporte de Analytics - RapiTeam'],
      ...
      await Share.shareXFiles(
        [XFile(filePath)],
        subject: 'Reporte de Analytics - RapiTeam',
        text: 'Reporte generado el ${DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now())}',
      );

      if (mounted) {
        RtSnackbar.show(context, message: 'Reporte generado y compartido exitosamente', type: RtSnackbarType.success);
      }
    } catch (e) {
...
class HourlyChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ...
      ..color = RtColors.brand.withValues(alpha: 0.8);
