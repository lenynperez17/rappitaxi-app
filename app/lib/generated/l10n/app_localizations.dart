...
abstract class AppLocalizations {
  ...
  /// Título para selector de ubicación de origen en mapa
  ///
  /// In es, this message translates to:
  /// **'Seleccionar punto de recogida'**
  String get selectPickupLocation;

  /// Título para selector de ubicación de destino en mapa
  ///
  /// In es, this message translates to:
  /// **'Seleccionar destino'**
  ...
  /// No description provided for @rapiteamTaxi.
  ///
  /// In es, this message translates to:
  /// **'RAPITEAM'**
  String get rapiteamTaxi;
  ...
  /// No description provided for @howToUseRapiteam.
  ///
  /// In es, this message translates to:
  /// **'¿Cómo quieres usar RapiTeam?'**
  String get howToUseRapiteam;
  ...
  /// Título billetera RapiTeam
  ///
  /// In es, this message translates to:
  /// **'Billetera RapiTeam'**
  String get rapiteamWallet;
  ...
  String get complaintsBook;

  /// Título información legal
  ///
  /// In es, this message translates to:
  /// **'Información Legal'**
  String get legalInformation;

  /// Información legal del libro de reclamaciones
  ///
  /// In es, this message translates to:
  ...
  ///
  /// In es, this message translates to:
  /// **'Ley N° 29571 - INDECOPI (Perú)'**
  String get complaintsLaw;
  ...
  /// Mensaje sin reclamos
  ///
  /// In es, this message translates to:
  /// **'No tienes reclamos registrados'**
  String get noComplaints;

  /// Descripción sin reclamos
  ///
  /// In es, this message translates to:
  /// **'Aquí aparecerán tus reclamos y quejas cuando los presentes'**
  String get noComplaintsDescription;

  /// Título datos del proveedor
  ///
  /// In es, this message translates to:
  /// **'Datos del Proveedor'**
  String get providerData;

  /// Etiqueta respuesta vencida
  ///
  /// In es, this message translates to:
  /// **'Respuesta vencida'**
  String get overdueResponse;

  /// Etiqueta días para responder
  ///
  /// In es, this message translates to:
  /// **'días para responder'**
  String get daysToRespond;
  ...
  /// Descripción tipo reclamo
  ///
  /// In es, this message translates to:
  /// **'Respuesta obligatoria en 30 días'**
  String get claimDescription;

  /// Descripción tipo queja
  ///
  /// In es, this message translates to:
  /// **'Malestar por la atención'**
  String get complaintDescription;

  /// Título datos del consumidor
  ///
  /// In es, this message translates to:
  /// **'Datos del Consumidor'**
  String get consumerData;

  /// Documento de identidad
  ///
  /// In es, this message translates to:
  /// **'DNI'**
  String get dniDocument;
  ...
  /// Campo detalle del reclamo
  ///
  /// In es, this message translates to:
  /// **'Detalle del reclamo'**
  String get complaintDetail;

  /// Helper mínimo caracteres
  ///
  /// In es, this message translates to:
  /// **'Mínimo {count} caracteres'**
  String minCharacters(int count);

  /// Error mínimo caracteres
  ///
  /// In es, this message translates to:
  /// **'Debe tener al menos {count} caracteres'**
  String minCharactersError(int count);

  /// Campo pedido del consumidor
  ///
  /// In es, this message translates to:
  /// **'¿Qué solicitas como solución?'**
  String get consumerRequest;

  /// Hint pedido del consumidor
  ///
  /// In es, this message translates to:
  /// **'Describe lo que esperas como solución a tu reclamo'**
  String get consumerRequestHint;

  /// Texto aceptación de términos
  ///
  /// In es, this message translates to:
  ...
  ///
  /// In es, this message translates to:
  /// **'Reclamo registrado exitosamente. Número:'**
  ...
  /// Mensaje número copiado
  ///
  /// In es, this message translates to:
  /// **'Número de reclamo copiado'**
  ...
  /// Título respuesta vencida
  ///
  /// In es, this message translates to:
  /// **'Respuesta vencida'**
  String get responseOverdue;

  /// Descripción respuesta vencida
  ///
  /// In es, this message translates to:
  /// **'El plazo de 30 días ha vencido. Puedes presentar tu caso ante INDECOPI.'**
  String get overdueDescription;

  /// Título respuesta del proveedor
  ///
  /// In es, this message translates to:
