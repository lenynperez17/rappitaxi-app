# RAPITEAM - Terraform Infrastructure Configuration
...
resource "google_service_account" "functions_sa" {
  ...
  display_name = "RAPITEAM Cloud Functions Service Account"
  description  = "Service account for RAPITEAM Cloud Functions"
}
...
resource "google_cloudbuild_trigger" "deploy_trigger" {
  ...
  description = "Deploy RAPITEAM Cloud Functions"
